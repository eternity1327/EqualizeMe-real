...
async function loadProfile() {
  ...
  try {
    ...
    if (profile.error) {
      ...
      noteEl.textContent = "No profile yet — take the sound test";
    } else {
      ...
      bassEl.textContent = signed(profile.bassGain);
      trebleEl.textContent = signed(profile.trebleGain);
      presenceEl.textContent = signed(profile.presenceGain);
      noteEl.textContent = from;
    }
